...
public sealed class ResolveConversationCommandValidator : AbstractValidator<ResolveConversationCommand>
{
    public ResolveConversationCommandValidator()
    {
        ...
        RuleFor(x => x.ReasonCode)
            .Must(reason => string.Equals(reason?.Trim(), ConversationControlReasonCodes.Resolve, StringComparison.Ordinal))
